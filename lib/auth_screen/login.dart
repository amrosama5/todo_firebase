                  ...
                  if(formKey.currentState!.validate())
                  {
                      FirebaseFunction.loginUser(
                        context: context,
                          ...
                          onError: (error){
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(error,style: TextStyle(color: error == AppLocalizations.of(context)!.verifyEmail ?Colors.black : Colors.white),),backgroundColor:error == AppLocalizations.of(context)!.verifyEmail ?Colors.amber:Colors.red,));
                          }
                      );
                  }
                },
